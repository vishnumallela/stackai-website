      ...
      <section className="relative flex min-h-[calc(100dvh-2rem)] flex-col overflow-hidden rounded-3xl bg-black shadow-[0_24px_70px_-20px_rgba(0,0,0,0.45)] sm:min-h-[calc(100dvh-3rem)]">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div
            ...
            style={{ backgroundImage: "url(/textures/globe.jpg)" }}
          />
          ...
          <div className="grid grid-cols-1 flex-1 items-center gap-6 pt-20 sm:gap-10 sm:pt-24 lg:grid-cols-[1fr_1.3fr]">
            ...
            <div className="min-w-0 text-center lg:text-left">
              <motion.h1
                ...
                className="mx-auto max-w-2xl text-balance font-display text-3xl font-semibold leading-[1.07] tracking-tight text-white drop-shadow-[0_2px_14px_rgba(0,0,0,0.45)] sm:text-6xl lg:mx-0 lg:text-7xl"
              >
              ...
              <motion.p
                ...
                className="mx-auto mt-4 max-w-md text-balance text-base font-medium leading-relaxed text-white/85 drop-shadow-[0_1px_10px_rgba(0,0,0,0.4)] sm:mt-6 sm:text-lg lg:mx-0"
              >
